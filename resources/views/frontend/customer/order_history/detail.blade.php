						...
						<table class="table table-hover table-sm table-responsive col-md-9" style="background-color: white;">
							<tbody>
								...
								<tr>
									...
									<td>Thành tiền<p><b>{{number_format($item->sub_total)}}đ</b></p>
									</td>
								...
								<div class="modal fade" id="review{{$item->review->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel{{$item->review->id}}" aria-hidden="true">
